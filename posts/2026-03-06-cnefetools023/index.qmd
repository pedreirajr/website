...
A new version of `{cnefetools}` (v0.2.3) is now on CRAN. This release fixes a silent coverage gap in the H3 grid builder and adds caching to the `cnefe_counts()` and `compute_lumi()` functions.
